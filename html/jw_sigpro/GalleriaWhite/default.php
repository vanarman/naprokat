...
<div id="sigProGalleriaWhite<?php echo $gal_id; ?>" class="sigProContainer sigProGalleriaWhiteContainer<?php echo $extraWrapperClass; ?>">
	...
	<div class="sigProGalleriaWhitePlaceholderContainer">
		<div class="sigProGalleriaWhitePlaceholder">
			<a href="<?php echo $gallery[0]->sourceImageFilePath; ?>" class="sigProGalleriaWhiteTargetLink<?php echo $extraClass; ?>" rel="<?php echo $relName; ?>[gallery<?php echo $gal_id; ?>]" title="<?php echo $gallery[0]->captionDescription.$gallery[0]->downloadLink.$modulePosition; ?>" target="_blank"<?php echo $customLinkAttributes; ?>>
		...
		<li class="sigProThumb">
			<span class="sigProLinkOuterWrapper">
				<span class="sigProLinkWrapper">
					<a href="<?php echo $photo->sourceImageFilePath; ?>" class="sigProGalleriaWhiteLink sigProLink<?php if($count==0) echo ' sigProLinkSelected'; ?>" style="width:<?php echo $photo->width / 4; ?>px;height:<?php echo $photo->height / 4; ?>px;" title="<?php echo $photo->captionDescription.$photo->downloadLink.$modulePosition; ?>" target="_blank">
						<?php if(($gal_singlethumbmode && $count==0) || !$gal_singlethumbmode): ?>
						<img class="sigProImg" src="<?php echo $transparent; ?>" alt="<?php echo JText::_('JW_SIGP_LABELS_08').' '.$photo->filename; ?>" title="<?php echo JText::_('JW_SIGP_LABELS_08').' '.$photo->filename; ?>" style="width:<?php echo $photo->width / 4; ?>px;height:<?php echo $photo->height / 4; ?>px;background-image:url(<?php echo $photo->thumbImageFilePath; ?>);" />
						<?php endif; ?>
						<?php if($gal_captions): ?>
