...
<div id="k2Container" class="row itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemList col-md-12">
		...
		<div id="itemListLeading" class="row">
			...
			<div class="row itemContainer<?php echo $lastContainer; ?> <?php echo (count($this->leading)==1) ? '' : 'col-md-'.number_format(12/$this->params->get('num_leading_columns'), 0).'"'; ?>">
				<?php
